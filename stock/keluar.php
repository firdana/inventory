                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Keluar</h2>
                                    <a href="barang_keluar_auto.php" style="margin-bottom:20px; padding:10px 5px !important; margin-right:-1000px !important" class="btn btn-warning col-md-1"><span class="glyphicon glyphicon-plus"></span>Scan</a>
									<button style="margin-bottom:20px; padding:10px 5px !important" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-1"><span class="glyphicon glyphicon-plus"></span>Manual</button>
                                </div>
										 ...
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($brg)){
												...
												<tr>
													...
													<td><?php echo $b['nama'] ?> <?php echo $b['jenis'] ?> <?php echo $b['warna'] ?> <?php echo $b['merk'] ?></td>
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $b['nama'] ?> <?php echo $b['jenis'] ?> <?php echo $b['warna'] ?> <?php echo $b['merk'] ?>" disabled>
						...
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?> <?php echo $d['warna'] ?> <?php echo $d['merk'] ?>, Uk. <?php echo $d['ukuran'] ?> --- Stock : <?php echo $d['stock'] ?></option>
										<?php
								}
								?>		
									</select>
