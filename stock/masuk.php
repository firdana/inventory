                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Masuk</h2>
                                   <a href="barang_masuk_auto.php" style="margin-bottom:20px; padding:10px 5px !important; margin-right:-1000px !important" class="btn btn-warning col-md-1"><span class="glyphicon glyphicon-plus"></span>Scan</a>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="text" id="tgl" name="tgl" class="form-control" value="<?php echo $b['tgl'] ?>" disabled>
                                                            
                                                            <label for="nama">Barang</label>
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $b['nama'] ?> <?php echo $b['merk'] ?> <?php echo $b['jenis'] ?> <?php echo $b['warna'] ?>" disabled>
						...
						<div class="modal-body">
							...
							<!--	<div class="form-group">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?> <?php echo $d['warna'] ?> <?php echo $d['merk'] ?>, Uk. <?php echo $d['ukuran'] ?></option>
										<?php
								}
								?>
									</select>
