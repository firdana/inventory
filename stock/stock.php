...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', jenis='$jenis', warna='$warna', merk='$merk', ukuran='$ukuran', lokasi='$lokasi' where idx='$idx'");
			...
			<?php 
				...
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama']. "</u> <u>".($p['warna']). "</u> <u>".($p['merk'])."</u> &nbsp <u>".$p['ukuran']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td><?php echo $p['stock'] . " pasang" ?></td>
													<td><?php echo $p['lokasi'] ?></td>
                                                    <td align="center"><button data-toggle="modal" data-target="#edit<?=$idb;?>" class="btn btn-warning">Edit</button> <button data-toggle="modal" data-target="#del<?=$idb;?>" class="btn btn-danger">Del</button > <button data-toggle="modal" data-target="#barcode<?=$idb;?>" class="btn btn-info">Barcode Print</button></td>
												</tr>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
															...
															<select name="jenis" id="jenis" class="custom-select form-control" value="<?php echo $p['jenis'] ?>">
                                                            ...
                                                            <input type="text" id="warna" name="warna" class="form-control" value="<?php echo $p['warna'] ?>">
                                                            ...
                                                            <input type="text" id="stock" name="stock" class="form-control" value="<?php echo $p['stock'] . " pasang" ?>" disabled>
                                                    ...
                                                    <!-- The Modal -->
                                                    <div class="modal fade" id="barcode<?=$idb;?>">
                                                        <div class="modal-dialog">
                                                        <div class="modal-content">
                                                        <form method="post">
                                                            <!-- Modal Header -->
