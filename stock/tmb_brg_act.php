...
$text = $nama.substr($warna,0,2).$ukuran;
...
$target_path = $tempdir . $text . ".png";

//cek apakah server menggunakan http atau https
$protocol = stripos($_SERVER['SERVER_PROTOCOL'], 'https') === 0 ? 'https://' : 'http://';
       
//url file image barcode 
$fileImage = $protocol . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . "./barcode.php?text=" . $text . "&print=true&size=65";
...
$query = mysqli_query($conn,"insert into sstock_brg values('','$nama','$jenis','$warna','$merk','$ukuran','$stock','$satuan','$lokasi','$new_text','$text')");
